...
testCase('nodes.splitTree.Shallow', function() {
  testing.withSample('<p contenteditable><e1>one</e1>|<e2>two</e2><e3>three</e3></p>',
    function(selection) {
...
testCase('nodes.splitTree.Deep', function() {
  testing.withSample('<p contenteditable><b>bold_1<i>italic_1<s>strike_1|strike_2</s>italic_2</i>bold_2</b></p>',
    function(selection) {
